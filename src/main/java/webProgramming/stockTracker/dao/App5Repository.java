...
public class App5Repository {
	...
	private RowMapper<Person> rowMapper = new RowMapper<Person>() {
		...
		public Person mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			person.setProductName(rs.getString("pname"));
	...
	public void create(Person person) {
		String sql = "insert into person(pname, lname, dob) values(?, ?, ?)";
		jdbcTemplate.update(sql, person.getProductName(), person.getLastName(), person.getDateOfBirth());
	}
